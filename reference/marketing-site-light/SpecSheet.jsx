...
function MktSpecSheet() {
  ...
  return (
    <section style={{ padding: '88px 48px', background: 'var(--bg-inset)', borderTop: '1px solid var(--line)', borderBottom: '1px solid var(--line)' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, marginTop: 56 }}>
          <div style={{ position: 'relative', aspectRatio: '4/5', background: 'var(--bg)', border: '1px solid var(--line)', borderRadius: 8, overflow: 'hidden' }}>
            {/* Engineering-drawing placeholder */}
            <svg width="100%" height="100%" viewBox="0 0 400 500">
              <g stroke="var(--fg1)" strokeWidth="1" fill="none">
              ...
              <g fill="var(--fg2)" style={{ font: '10px var(--font-mono)' }}>
                <text x="20" y="50">A</text>
                <text x="20" y="170">B</text>
                <text x="20" y="380">C</text>
              </g>
            </svg>
            <div style={{ position: 'absolute', bottom: 14, left: 14, font: 'var(--type-mono-sm)', color: 'var(--fg-accent)', letterSpacing: '0.06em' }}>
