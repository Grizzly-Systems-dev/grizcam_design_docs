...
function MktHeader() {
  ...
  return (
    <header style={{
      ...
      background: 'rgba(26,24,18,0.92)', borderBottom: '1px solid var(--line)', backdropFilter: 'blur(8px)',
      display: 'flex', alignItems: 'center', justifyContent: 'space-between',
      padding: '0 48px',
    }}>
      <a href="#" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
        <img src="../../assets/stacked-primary.svg" alt="Grizzly Systems" style={{ height: 30 }} />
      </a>
